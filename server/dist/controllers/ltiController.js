...
import { generateNonce, generateState } from '../utils/jwt.js';
import { createLTISession, getLTISessionByNonce, deleteLTISession, getUserByLTIUserId, createUser, updateUser, createOrUpdateContext, createOrUpdateResourceLink, createLaunchRecord } from '../services/firestore.js';
...
export async function handleLaunch(req, res, next) {
    try {
...
function mapLTIRolesToAppRole(roles) {
