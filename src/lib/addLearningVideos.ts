...
const educationalVideos = [
  ...
  {
    title: "ما هي إدارة المشاريع الجامعية؟",
    description: "شرح مفصل لمنهجية إدارة المشاريع الجامعية وفوائدها التعليمية. يوضح الفيديو كيفية تطبيق هذه المنهجية، أمثلة ناجحة، وتأثيرها على تطوير مهارات الطلاب.",
    type: "video",
    category: "education",
